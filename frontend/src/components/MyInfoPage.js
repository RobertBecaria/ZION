  ...
  return (
    <div className="my-info-page">
      ...
      <div className="info-note">
        <p>
          <strong>Примечание:</strong> Для изменения адреса, семейного положения и других персональных 
          данных используйте соответствующие модули платформы (Семья, Профиль).
        </p>
        <p>
          Эта страница показывает централизованный просмотр всех ваших данных, которые используются 
          в различных разделах платформы.
        </p>
      </div>
    </div>
  );
